...
func (m *MockService) GetPsycheProfile(ctx context.Context, req *v1User.GetPsycheProfileReq) (*v1User.GetPsycheProfileRes, error) {
	profile := v1User.GetPsycheProfileRes{
		...
		Archetypes: []v1User.ArchetypeProfileItem{
			{Type: "self", Score: 62, InsightKey: "profileArchetypeSelfInsight"},
			{Type: "persona", Score: 48, InsightKey: "profileArchetypePersonaInsight"},
			{Type: "shadow", Score: 42, InsightKey: "profileArchetypeShadowInsight"},
			{Type: "anima", Score: 38, InsightKey: "profileArchetypeAnimaInsight"},
			{Type: "sage", Score: 44, InsightKey: "profileArchetypeSageInsight"},
		},
